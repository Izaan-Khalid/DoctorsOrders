		...
		<div className="max-w-md mx-auto mt-10 p-6 bg-white shadow-lg rounded-lg">
			...
			>
				...
				<div className="relative">
					<label className="block text-gray-700 font-medium mb-2 items-center group">
						Urgency
						<span className="ml-2 relative flex items-center">
							...
							<div className="absolute left-5 bottom-5 hidden group-hover:block z-10 w-64 p-2 text-xs text-white bg-gray-700 rounded shadow-lg">
								...
								<br />
								Non-critical patient needs (e.g., extra blanket, pillow
								adjustment).
								<br />
								Response: 2-4 hours.
								<br />
								<strong style={{ color: "#FFC107" }}>
									Level 2: Mild Urgency
								</strong>
								<br />
								Timely but non-urgent (e.g., assistance with food or medication
								reminders).
								<br />
								Response: 1-2 hours.
								<br />
								<strong style={{ color: "#FF9800" }}>
									Level 3: Moderate Urgency
								</strong>
								<br />
								Affects care, but not life-threatening (e.g., IV bag
								replacement).
								<br />
								Response: 30-60 mins.
								<br />
								...
								<br />
								Immediate attention needed to avoid complications (e.g., pain
								medication).
								<br />
								Response: 15-30 mins.
								<br />
								<strong style={{ color: "#D32F2F" }}>
									Level 5: Critical Urgency
								</strong>
								<br />
								Urgent care required (e.g., severe pain or equipment
								malfunction).
								<br />
								Response: 5-15 mins.
							</div>
