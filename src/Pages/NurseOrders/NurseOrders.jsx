...
export const NurseOrders = ({ data }) => {
	...
	return (
		<div className="max-w-8xl mx-auto mt-5 p-6 bg-white shadow-lg rounded-lg">
			{/* Button to navigate back to nurse form */}
			<div className="flex w-full mb-4 justify-between items-end">
				<AuthButtons /> {/* Auth buttons here */}
				<button
			...
			<div className="mb-10">
				...
				<div className="overflow-x-auto">
					<table className="min-w-full bg-white border border-gray-300">
						<thead>
							<tr>
								<th className="border px-2 py-2 text-xs lg:text-base">
									Complete
								</th>
								<th className="border px-2 py-2 text-xs lg:text-base">
									Patient Name
				...
				<div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
					<div className="bg-white p-6 rounded shadow-lg">
						...
						<p>
							...
							{selectedOrder.patientName} for a {selectedOrder.itemRequested} as
							completed?
						</p>
						<div className="mt-4">
							<button
